...
**状态：0.2.4 开发预览版；尚未达到 Night Sky 全功能/性能等价。**

## 下载

[下载安卓 APK（发布页）](https://github.com/schlapiadeziel-rgb/Starlight-Android/releases/tag/v0.2.4)
...
Android 8.0+，安装预览 APK。第一次打开先设置实际位置，App 自动开启手机指向；右侧准星可切换手动模式。画面中心对应手机背面方向。AR 不会识别相机照片中的星星，其叠加位置来自星表和传感器。附近磁铁和磁性手机壳会影响方向；可将手机转动呈 8 字校准。右侧齿轮显示传感器精度状态；不需要手动指定方向。缺少旋转向量传感器时仍可手动探索。
