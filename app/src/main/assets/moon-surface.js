...
(function(root){
 ...
 function draw(target,image,phase){
  const source=document.createElement('canvas');source.width=image.naturalWidth||image.width;source.height=image.naturalHeight||image.height;
 ...
 const api={sample,draw};root.SkyMoonSurface=api;if(typeof module!=='undefined')module.exports=api;
